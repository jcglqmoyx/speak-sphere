...
type Vocabulary struct {
	ID              int            `gorm:"primaryKey" json:"id" form:"id"`
	Vocabulary      string         `gorm:"column:vocabulary" form:"vocabulary" json:"vocabulary"`
	Meaning         string         `gorm:"column:meaning" form:"meaning" json:"meaning"`
	VocabularySetID int            `gorm:"column:vocabulary_set_id" form:"vocabulary_set_id" json:"vocabulary_set_id"`
	UserID          int            `gorm:"column:user_id" form:"user_id" json:"user_id"`
...
type User struct {
	...
	TotalVocabularyCount   int            `gorm:"total_vocabulary_count" form:"total_vocabulary_count" json:"total_vocabulary_count"`
	CurrentVocabularySetID int            `gorm:"current_vocabulary_set_id" form:"current_vocabulary_set_id" json:"current_vocabulary_set_id"`
